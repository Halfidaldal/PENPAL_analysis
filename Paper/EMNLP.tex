...
Baseline valence asymmetry differed by condition. Human--AI stories showed the largest baseline gap (mean $A_{\mathrm{baseline}}=0.174$, 95\% CI $[0.147,0.202]$), followed by Human--Human (mean $=0.122$, 95\% CI $[0.094,0.152]$) and AI--AI (mean $=0.084$, 95\% CI $[0.071,0.097]$). The planned Human--AI versus same-type contrast was significant ($\Delta=0.071$, 95\% CI $[0.038,0.104]$, $p<.001$).
...
Directional valence alignment was positive in all conditions. The unsigned per-story alignment-asymmetry measure was descriptively highest in Human--AI (mean $A_{\mathrm{valence}}=0.612$, 95\% CI $[0.523,0.708]$), compared with Human--Human (mean $=0.516$, 95\% CI $[0.389,0.647]$) and AI--AI (mean $=0.490$, 95\% CI $[0.416,0.569]$), but the cross-condition tests were not reliable (ANOVA $p=.137$; Kruskal--Wallis $p=.289$; planned Human--AI versus same-type contrast $p=.079$).

The signed directional diagnostic was significant only in Human--AI (mean signed $\Delta z=0.192$, one-sample $p=.013$), suggesting a consistent direction of valence-alignment asymmetry in the mixed human--LLM condition. The corresponding signed tests were not reliable for Human--Human ($p=.860$) or AI--AI ($p=.217$).
\begin{figure}[t]
  \centering
...
%note that this last figure is agent-based / slot-based, and is therefore a bit redundant for H-H and A-A. It is just coupled to the last, short paragraph abov . 
\begin{figure}[t]
  \centering
