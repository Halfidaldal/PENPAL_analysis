...
from nes.cleaning import filter_by_edit_distance, build_full_story_text, clean_user_ai_start
...
def main():
    ...
    # Keep backward compatibility with downstream scripts expecting an 'ai' column
    if 'ai' not in df_filtered.columns and 'user2' in df_filtered.columns:
        df_filtered = df_filtered.copy()
        df_filtered['ai'] = df_filtered['user2']
